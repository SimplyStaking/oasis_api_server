...
func setup() {
	...
	_, stakingClient, err := rpc.StakingClient("unix:/home/vvol/serverdir/node/internal.sock")
	if err != nil {
		panic(err)
	}
...
func TestStakingObject_2(t *testing.T){
	...
	_, stakingClient, err := rpc.StakingClient("unix:/home/vvol/serverdir/node2/internal.sock")
	if err != nil {
		panic(err)
	}
