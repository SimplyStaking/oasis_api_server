...
func GetTotalSupply(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil{
		json.NewEncoder(w).Encode(responses.Response_error{"Failed to get TotalSupply!"})
	...
	json.NewEncoder(w).Encode(responses.Response_quantity{totalSupply})
}
...
func GetCommonPool(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil{
		json.NewEncoder(w).Encode(responses.Response_error{"Failed to get Common Pool!"})
	...
	json.NewEncoder(w).Encode(responses.Response_quantity{commonPool})
}
...
func GetStakingStateToGenesis(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil{
		json.NewEncoder(w).Encode(responses.Response_error{"Failed to get Staking Genesis State!"})
	...
	json.NewEncoder(w).Encode(responses.Response_stakingGenesis{genesisStaking})
}
...
func GetThreshold(w http.ResponseWriter, r *http.Request) {
	...
	if kind == -1 {
		//Stop the code here no need to establish connection and reply
		json.NewEncoder(w).Encode(responses.Response_error{"Unexepcted value found, kind needs to be string of int!"})
		return
	}
	...
	if err != nil{
		json.NewEncoder(w).Encode(responses.Response_error{"Failed to get Threshold!"})
	...
	json.NewEncoder(w).Encode(responses.Response_quantity{threshold})
}
...
func GetAccounts(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil{
		json.NewEncoder(w).Encode(responses.Response_error{"Failed to get Accounts!"})
	...
	json.NewEncoder(w).Encode(responses.Response_allAccounts{accounts})
}
...
func GetAccountInfo(w http.ResponseWriter, r *http.Request) {
	...
	if len(ownerKey) == 0 {
		...
		json.NewEncoder(w).Encode(responses.Response_error{"ownerKey can't be empty!"})
		return
	}
	...
	if err != nil{
		json.NewEncoder(w).Encode(responses.Response_error{"Failed to get Account!"})
	...
	json.NewEncoder(w).Encode(responses.Response_account{account})
}
...
func GetDelegations(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil{
		json.NewEncoder(w).Encode(responses.Response_error{"Failed to get Delegations!"})
	...
	json.NewEncoder(w).Encode(responses.Response_delegations{delegations})
}
...
func GetDebondingDelegations(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil{
		json.NewEncoder(w).Encode(responses.Response_error{"Failed to get Debonding Delegations!"})
	...
	json.NewEncoder(w).Encode(responses.Response_DebondingDelegations{debondingDelegations})
}